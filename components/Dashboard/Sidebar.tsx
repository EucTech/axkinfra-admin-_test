...
const Sidebar = () => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between h-24 px-4 border-b border-[#E5E5E5]">
        {!isCollapsed && (
            ...
            <Link href={link} key={name} onClick={handleLinkClick}>
              <div
                className={classNames(
                  ...
                  {
                    "bg-[#262A48] text-[#EBFFE2] font-medium": activePath === link,
                    "text-[#525252] hover:bg-[#f3f3f3] font-medium": activePath !== link,
                    "justify-center rounded-none": isCollapsed,
      ...
      <div className={`flex flex-col gap-6 py-6 ${isCollapsed ? "items-center justify-center" : "px-6"}`}>
        <div className="flex items-center gap-3 cursor-pointer">
          ...
          {!isCollapsed && (
            <div className="flex flex-col">
              <p className="text-[16px] font-medium text-[#525252]">Uche</p>
              <p className="text-[16px] font-medium text-[#525252]">Ezeibe</p>
            </div>
          )}
        </div>
        ...
        <div className="flex items-center gap-2 text-[#525252] cursor-pointer hover:text-[#3f3e3e]">
          <MdLogout size={26} />
          {!isCollapsed && <p className="text-[16px] font-normal">Logout</p>}
        </div>
      </div>
    </div>
  );
